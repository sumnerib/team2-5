...
public class Answer extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        String query = "SELECT question FROM questions WHERE questionId = " 
                + questionId;
        ResultSet results = db.doQuery(query);
        
        try {
            results.next();
            request.setAttribute("question", results.getString("question"));
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            aid = result.getInt(1) + 1;
             ...
             db.addAnswer(aid, answer, Integer.parseInt(request.getParameter("questionId")), 
